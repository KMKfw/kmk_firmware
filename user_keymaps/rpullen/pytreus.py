...
keyboard.keymap = [
    ...
    [
        RES,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, PSCR,     KC.PSLS, KC.RGUI, XXXXXXX, XXXXXXX, XXXXXXX, KC.MINS,
    ...
    [
        RES,      KC.N1,   KC.N2,   KC.N3,   KC.N4,      XXXXXXX,      DEBUGWL,    PRINT,   SAVE_AS,   KC.N9,   KC.N0,   KC.MINS,
