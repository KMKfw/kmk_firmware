...
class TestMacro(unittest.TestCase):
    ...
    def test_6(self):
        self.kb.test(
            ...
            [(6, True), (6, False)],
            [{KC.LCTL},
             {KC.LCTL, KC.LSFT, KC.F}, {KC.LCTL},
             {KC.LCTL, KC.O}, {KC.LCTL},
             {KC.LCTL, KC.O}, {KC.LCTL},
             {KC.LCTL, KC.N1},
             {KC.LCTL}, {}],
        )
    ...
    def test_7_ralt(self):
        ...
        self.kb.test(
            ...
            [(7, True), (7, False)],
            [{KC.LALT},
             {KC.LALT, KC.N1}, {KC.LALT},
             {KC.LALT, KC.F}, {KC.LALT},
             {KC.LALT, KC.N3}, {KC.LALT},
             {KC.LALT, KC.N7}, {KC.LALT},
             {KC.LALT, KC.A}, {KC.LALT},
             {},
             {KC.LSFT, KC.N1}, {},
             ],
        )
