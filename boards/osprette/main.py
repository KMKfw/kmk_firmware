...
keyboard.modules = [layers, holdtap, mouse_key]
...
keyboard.keymap = [
    [  # QWERTY
        ...
        KC.Q,  A_SFT,  S_L5,    D_L1,    F_L3,     KC.G,    KC.H,    J_L4,    K_L2,    L_L6, SCLN_SFT, KC.P,
    ...
    [  # RIGHT SYMBOLS
        ...
        _______, KC.CIRC, KC.ASTR, KC.AMPR, _______, _______, KC.HASH, KC.TILD, KC.SLSH, KC.DQUO,  KC.DLR, _______,
                 _______, _______, _______, _______, _______, _______, KC.MINS, KC.BSLS,  KC.GRV, _______,
                                   _______, _______, _______, _______,
    ],
    [  # LEFT SYMBOLS
                          KC.COLN, KC.LABK, KC.RABK, KC.SCLN, _______, _______, _______, _______,
        _______, KC.LCBR, KC.RCBR, KC.LPRN, KC.RPRN,   KC.AT, _______, _______,  KC.EQL, KC.PLUS, KC.PERC, _______,
                 _______, KC.EXLM, KC.LBRC, KC.RBRC, _______, _______, _______, _______, _______, _______,
                                            _______, _______, _______, _______,
    ],
    [  # 5 FUNCTION
                          _______, _______, _______, _______, _______, KC.F7, KC.F8, KC.F9,
        _______, _______, _______, _______, _______, _______, _______, KC.F4, KC.F5, KC.F6, KC.F11, KC.F10,
        _______, _______, _______, _______, _______, _______, KC.F1, KC.F2, KC.F3, KC.F12,
                                   _______, _______, _______, _______,
    ],
    [  # 6 NUMBERS
                          KC.N7,   KC.N8,   KC.N9,   KC.PLUS, _______, _______, _______, _______,
        KC.SLSH, KC.N0,   KC.N1,   KC.N2,   KC.N3,   KC.MINS, _______, _______, _______, _______, _______, _______,
        KC.ASTR,   KC.N4, KC.N5,   KC.N6,   KC.EQL,  _______, _______, _______, _______, _______,
                                   _______, _______, _______, _______,
    ],
    [  # 7 ALWAYS AVAILABLE
                          _______, KC.COLN,  KC.ESC, _______, _______, _______, _______, _______,
        _______, _______, KC.PERC, KC.SLSH,  KC.ENT, _______, KC.DF(1), KC.LGUI, _______, _______, _______, KC.DEL,
