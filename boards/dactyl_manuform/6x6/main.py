...
keyboard.keymap = [
    ...
    [  #1
        ...
        KC.TRNS, KC.EXLM,   KC.AT, KC.HASH,  KC.DLR, KC.PERC,                        KC.CIRC, KC.AMPR, KC.ASTR, KC.TRNS, KC.LPRN, KC.RPRN,
    ...
    [  #2
        ...
        KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,                        KC.TRNS,  KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,
        KC.TRNS, KC.TRNS, KC.TRNS, KC.PGUP, KC.VOLU, KC.PAUS,                        KC.TRNS,  KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,
        KC.TRNS, KC.TRNS,  KC.INS, KC.SLCK, KC.MUTE, KC.MPLY,                        KC.TRNS, KC.RESET, KC.TRNS, KC.TRNS,  KC.RLD, KC.TRNS,
        KC.TRNS, KC.TRNS, KC.TRNS, KC.PGDN, KC.VOLD, KC.PSCR,                        KC.TRNS,  KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,
