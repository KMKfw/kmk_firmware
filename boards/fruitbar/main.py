...
keyboard.keymap = [
    ...
    # |------+------+------+------+------+------+------+------+------+------+------|------+------+------+------+------|
    # | Ctrl |  GUI |  Alt | Bksp |   FN | Space|      |      |      |      | Left | Down | Right| Bksp |
    # `---------------------------------------------------------------------------------------------------------------'
    [
        ...
        KC.LCTRL, KC.LGUI, KC.LALT, KC.SPC,  FN,     KC.SPC, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.LEFT, KC.DOWN,  KC.RGHT, KC.BSPC, KC.TRNS,  KC.TRNS,
    ],
    # Alt
    # ,----------------------------------------------------------------------------.
