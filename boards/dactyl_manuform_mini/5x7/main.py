...
M_DEL = KC.MT(KC.DEL, KC.MEH)
H_BSPC = KC.MT(KC.BSPC, KC.HYPR)
...
keyboard.keymap = [
    [   # 0
        ...
        KC.LCTL, KC.LGUI, KC.LEFT, KC.RGHT,        KC.MO(1),  KC.SPC, KC.LALT,      KC.LALT, KC.ENT, KC.MO(2),          KC.UP, KC.DOWN, KC.RGUI, KC.RCTL,
                                                               M_DEL, KC.HOME,       KC.END, H_BSPC,
    ],
    [  #1
        KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,                      KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,
        KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.PGUP, KC.TRNS, KC.TRNS,                      KC.TRNS, KC.NLCK,   KC.P7,   KC.P8,   KC.P9, KC.PMNS, KC.TRNS,
        KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,                      KC.TRNS, KC.PAST,   KC.P4,   KC.P5,   KC.P6, KC.PPLS, KC.TRNS,
        KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS, KC.PGDN, KC.TRNS,                                        KC.PSLS,   KC.P1,   KC.P2,   KC.P3, KC.PENT, KC.TRNS,
        KC.TRNS, KC.TRNS, KC.TRNS, KC.TRNS,          KC.TRNS,   KC.NO, KC.NO,      KC.LALT, KC.RSFT,   KC.NO,            KC.P0, KC.PDOT, KC.TRNS, KC.TRNS,
