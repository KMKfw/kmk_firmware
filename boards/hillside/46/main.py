...
keyboard.modules.append(AgSwap())
...
keyboard.keymap = [
    ...
    [
        KC.NO, KC.DF(0), KC.DF(1), KC.DF(2), KC.AG_SWAP, KC.CG_SWAP,                      KC.NO,   KC.F11,     KC.F12,     KC.PSCR,    KC.NO,      KC.RLD,
        KC.NO, KC.NO,    KC.BRID,  KC.BRIU,  KC.AG_NORM, KC.CG_NORM,                      KC.NO,   KC.RGB_VAI, KC.RGB_HUI, KC.RGB_SAI, KC.RGB_ANI, KC.NO,
