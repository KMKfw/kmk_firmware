...
keyboard.keymap = [
    ...
    [
        KC.NO,    KC.DF(0), KC.DF(1), KC.DF(2), KC.AG_SWAP, KC.CG_SWAP,                                            KC.NO,   KC.NO,      KC.NO,      KC.NO,      KC.NO,      KC.NO,
        KC.NO,    KC.NO,    KC.NO,    KC.NO,    KC.AG_NORM, KC.CG_NORM,                                            KC.NO,   KC.RGB_VAI, KC.RGB_HUI, KC.RGB_SAI, KC.RGB_ANI, KC.NO,
