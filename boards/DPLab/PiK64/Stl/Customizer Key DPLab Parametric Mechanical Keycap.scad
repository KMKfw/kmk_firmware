...
brickLength = 2; // brick Lego Length (2) KeyCap (14) Space Bar
...
key_profile = "disable"; // [dcs, oem, dsa, lsa, sa, g20, lego, dsa_flat, c64, disable]
...
module lego_row(n=3) {
    ...
    $height_slices = 10;
    $corner_radius = 0.25;  
    $total_depth = PLATE_HEIGHT*brickHeight + 1; // H pin
    $top_tilt = 0;
