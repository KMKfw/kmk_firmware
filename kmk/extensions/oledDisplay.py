...
class oled(Extension):
    def __init__(self, SDA, SCL, toDisplay:str = "ACTIVE LAYER", oWidth:int = 128, oHeight:int = 32, tileWidth:int = 128, tileHeight:int = 32, gridWidth:int = 1, gridHeight:int = 1):
